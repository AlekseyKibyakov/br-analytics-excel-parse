...
class Message(Base):
    ...
    id_Сообщения = sq.Column(sq.VARCHAR(50))
    Дата = sq.Column(sq.VARCHAR(50))
    Заголовок = sq.Column(sq.VARCHAR(50))
    Текст = sq.Column(sq.VARCHAR(10000))
    Url = sq.Column(sq.VARCHAR(150))
    Автор = sq.Column(sq.VARCHAR(100))
    Url_автора = sq.Column(sq.VARCHAR(150))
    Тип_автора = sq.Column(sq.VARCHAR(50))
    Пол = sq.Column(sq.VARCHAR(50))
    Возраст = sq.Column(sq.Integer)
    Тип_сообщения = sq.Column(sq.VARCHAR(25))
    Источник  = sq.Column(sq.VARCHAR(100))
    Тип_источника = sq.Column(sq.VARCHAR(50))
    ...
    Тональность = sq.Column(sq.VARCHAR(50))
    Роль_объекта = sq.Column(sq.VARCHAR(50))
    Агрессия = sq.Column(sq.Boolean, default=False)
    Страна = sq.Column(sq.VARCHAR(100))
    Регион = sq.Column(sq.VARCHAR(100))
    Город = sq.Column(sq.VARCHAR(100))
    Место = sq.Column(sq.VARCHAR(100))
    Адрес = sq.Column(sq.VARCHAR(100))
    Язык = sq.Column(sq.VARCHAR(50))
